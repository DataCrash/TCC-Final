    ...
    <footer class="page-footer  bg-secondary text-white fixed-bottom">
        <div class="container-fluid">
            <div class="row mx-auto my-2">
                ...
                <div class="col-4">
                    <div class="row">
                        <p><strong>"O aplicativo BootKamp é uma marca registrada do grupo Pandora Desenvolvimento LTDA."</strong></p>
                    </div>
                    <div class="row">
                        <address>"Avenida dos Bolinhos Mesclados, 11955 - Galpão C5 - Bairro: Lavras - CEP:00000-000 - Guarulhos/SP"</address>
                    </div>
                </div>
